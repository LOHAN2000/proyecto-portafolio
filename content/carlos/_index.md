...
<details>
  <summary>🔥 <span style="color:#f39c12;">Experiencia Profesional</span></summary>

### <span style="color:#f39c12;">Sol del Pacífico - Coordinador de TI</span>  
...
### <span style="color:#f39c12;">Tracklog Personal - Soporte de Equipos MDVR con IA</span>  
Junio 2022 – Presente  
...
<details>
  <summary>📂 <span style="color:#f39c12;">Proyectos Destacados</span></summary>

### <span style="color:#f39c12;">🔹 Sistema de Gestión de Incidencias</span>  
Desarrollo de una plataforma para el registro y seguimiento de incidencias de TI, facilitando la comunicación entre el equipo de soporte y los usuarios.  
*<span style="color:#f39c12;">Tecnologías:</span>* Python, Flask, PostgreSQL

### <span style="color:#f39c12;">🔹 Plataforma de Monitoreo de Equipos MDVR</span>  
Solución para visualizar y analizar datos en tiempo real de dispositivos MDVR, con IA para análisis predictivo de fallos y optimización de rendimiento.  
*<span style="color:#f39c12;">Tecnologías:</span>* Java, Spring Boot, Machine Learning

### <span style="color:#f39c12;">🔹 Aplicación de Optimización de Recursos</span>  
Aplicación que mejora el rendimiento de infraestructuras de TI con recomendaciones basadas en datos.  
*<span style="color:#f39c12;">Tecnologías:</span>* Node.js, Express, MongoDB
